...
import { ChevronRight, Eye, TriangleAlert } from 'lucide-vue-next'
...
<template>
  <div class="flex min-h-screen flex-col bg-surface">
    <header class="flex h-16 items-center justify-between border-b border-border bg-surface-raised px-6 shadow-sm">
      <div class="flex items-center gap-3 text-sm text-ink-muted">
        <span class="font-bold text-ink">Content Studio</span>
    ...
    <div class="flex flex-1">
      ...
      <aside class="flex w-[360px] flex-shrink-0 flex-col gap-6 border-l border-border bg-surface-raised px-7 py-8">
        <div data-test="reuse-indicator" class="flex flex-col gap-3">
          <span class="text-xs font-bold uppercase tracking-wide text-ink-muted">Used in challenges</span>
          ...
          <ul v-else class="flex flex-col gap-2">
            <li
              ...
              :key="id"
              class="flex items-center gap-2.5 rounded-md border border-border bg-surface-sunken px-3 py-2.5 text-sm"
            >
        ...
        <div class="flex flex-col gap-2.5">
          <span class="text-xs font-bold uppercase tracking-wide text-ink-muted">Student preview</span>
          <button
            type="button"
            data-test="open-preview"
            class="flex items-center justify-center gap-2 rounded-md border border-border bg-surface-raised px-3 py-2.5 text-sm font-semibold"
